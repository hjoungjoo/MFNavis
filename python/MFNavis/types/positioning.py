...
class SolveDiagnostics:
    ...
    # "cedar_center" / "sep_center" / "cedar_full" / "sep_full", or
...
class PointingEstimate:
    ...
    Focus screen's stable star-identity slots. A failed
    solve preserves the last successful set, so consumers must also
    match ``last_solve_success`` to the frame timestamp.
    """
