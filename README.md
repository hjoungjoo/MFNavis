...
## Public MF detector source (m2.6.5)

The detector and its PiFinder integration are maintained at [MFDS](https://github.com/hjoungjoo/MFDS),
a public, pinned submodule at `python/mf_detect_star`. This release uses [MFDS v0.2.0](https://github.com/hjoungjoo/MFDS/releases/tag/v0.2.0); see [release notes](release_notes/m2.6.5.md). No private repository key
