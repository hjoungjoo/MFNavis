...
| Batched comet propagation | Skyfield 1.55 `keplerlib.propagate`, Brandon Rhodes; orbit-axis correction by MagicFly in `python/MFNavis/comet_propagation.py` | [MIT license](LICENSES/MIT-Skyfield.txt); original notice also retained in the source |
