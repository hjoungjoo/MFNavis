...
- From the main menu, select Settings, scroll down to Advanced, then select Camera Type and
  ...
  ``imx477``.  It won't hurt to try each.  Keep the Mono variants unless you know your
  module is a colour unit.  Mono/Color only affects image processing, not whether the
  camera is detected.
